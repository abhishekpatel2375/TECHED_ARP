/*global history */
sap.ui.define([
		"super/controller/BaseController",
		...
		return BaseController.extend("super.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("super.view.ViewSettingsDialog", this);
