sap.ui.define([
		...
		return BaseObject.extend("super.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias super.model.ListSelector
			 */
			 ...
			 * @return {super.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
