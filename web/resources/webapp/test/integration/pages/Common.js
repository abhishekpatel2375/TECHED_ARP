sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("super/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("super.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["super/localService/mockserver"], function (mockserver) {
